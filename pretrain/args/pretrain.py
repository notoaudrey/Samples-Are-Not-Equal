...
from pretrain.utils.misc import omegaconf_select

try:
    from pretrain.data.dali_dataloader import PretrainDALIDataModule
except ImportError:
...
def parse_cfg(cfg: omegaconf.DictConfig, osr=False):
    ...
    if cfg.data.format == "dali":
        assert cfg.data.dataset in ["imagenet100", "imagenet", "custom", "imagenetdogs", "imagenet10", "tinyimagenet"]
